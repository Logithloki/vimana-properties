  ...
  return (
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Your trusted partner in finding your dream home. We provide quality listings and expert advice to make your property journey smooth and successful.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/properties?type=Office" className="text-gray-400 hover:text-white transition-colors">
                  Commercial
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                ...
                <span>123 Estate Street, New York, NY 10001</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        </div>        <div className="border-t border-gray-800 mt-8 pt-8">
